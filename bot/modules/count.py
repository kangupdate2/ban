...
def countNode(update, context):
    ...
    if is_gdrive_link(link):
        msg = sendMessage(f"Menghitung: <code>{link}</code>", context.bot, update.message)
        ...
        sendMessage('Kirim atau balas link Gdrive dengan perintah', context.bot, update.message)
